...
const PLANS = [
  {
    ...
    features: [
      { text: "기본 프로필", included: true },
      { text: "월 3회 AI 분석", included: true },
      { text: "공고 보기", included: true },
      { text: "커뮤니티 접근", included: true },
      { text: "전체 프로필 편집", included: false },
      { text: "AI 포트폴리오 생성", included: false },
      { text: "매칭 추천", included: false },
      { text: "캐스팅 디렉터 뷰", included: false },
      { text: "검색 우선 노출", included: false },
    ],
  },
  {
    key: "pro",
    ...
    popular: true,
    features: [
      { text: "전체 프로필 편집", included: true },
      { text: "무제한 AI 분석", included: true },
      { text: "AI 포트폴리오 생성", included: true },
      { text: "월 10회 매칭 추천", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "무제한 AI 분석", included: true },
      { text: "AI 포트폴리오 생성", included: true },
      { text: "무제한 매칭 추천", included: true },
      { text: "캐스팅 디렉터 뷰", included: true },
      { text: "검색 우선 노출", included: true },
      { text: "공유 카드 생성", included: true },
      { text: "목표 관리", included: true },
      { text: "커뮤니티 접근", included: true },
    ],
