...
export async function syncNotesToServer(authUserId, notes) {
  ...
  const rows = notes.map((n) => ({
    ...
    ai_model: n.aiModel || null,
    prompt_version: n.promptVersion || null,
...
function serverNoteToLocal(sn) {
  return {
    ...
    aiModel: sn.ai_model || undefined,
    promptVersion: sn.prompt_version || undefined,
    transcript: sn.transcript || undefined,
